...
class SmolAgentWrapper:
    ...
    def _get_smol_tools(self) -> List[Tool]:
        ...
        class EditFileTool(Tool):
            ...
            inputs = {
                ...
                "replacement_string": {"type": "string", "description": "Text to replace it with"}
            }
            output_type = "string"
            ...
            def forward(self, file_path: str, search_string: str, replacement_string: str) -> str:
                import asyncio
                result = asyncio.run(self.base_tools.edit_file(file_path, search_string, replacement_string))
                return str(result)
    ...
    async def run_task(self, task_description: str, target_file: str, verification: str) -> Dict[str, Any]:
