    ...
    <div className="h-full w-full p-8 pb-24 overflow-y-auto bg-surface-50">
      <div className="max-w-4xl mx-auto flex flex-col gap-8">
        ...
        <header>
          ...
          <p className="text-slate-500 mt-2">Manage LLM providers and core agent parameters.</p>
        </header>

        <div className="glass-panel p-8">
          <h2 className="text-xl font-semibold text-slate-800 mb-6 border-b border-slate-100 pb-2">LLM Provider</h2>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="flex flex-col gap-2">
              <label className="text-sm font-medium text-slate-700">Model Selector</label>
            ...
            <div className="flex items-center gap-3 mt-8">
              ...
              />
              <label htmlFor="autoFetch" className="text-sm font-medium text-slate-700">
