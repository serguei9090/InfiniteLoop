...
class ToolRegistry:
    ...
    def load_from_folder(self, folder_path: Path) -> Dict[str, Any]:
        ...
        loaded = {"success": True, "loaded": 0, "failed": 0, "tools": []}
            ...
            try:
                ...
                for attr_name in dir(module):
                    ...
                    if hasattr(attr, "name") and callable(attr):
                        ...
                        loaded["loaded"] += 1
                        loaded["tools"].append(
                            {"name": attr.name, "class": attr.__class__.__name__}
                        )
    ...
    def hot_load(self, category: str) -> Dict[str, Any]:
        ...
        if not category_path.exists():
            return {"success": False, "error": f"Category folder not found: {category}"}
    ...
    def discover_tools(self) -> Dict[str, Any]:
        ...
        results = {"success": True, "categories": {}, "total_loaded": 0}
