    ...
    async def _json_operation(self, args: dict) -> dict:
        ...
        if operation == "parse":
            ...
            try:
                ...
                return {"success": True, "output": json_str, "operation": "stringify"}
            except Exception as e:
                return {"success": False, "error": str(e)}

        else:
            return {"success": False, "error": f"Unknown JSON operation: {operation}"}
...
<{element_name}>
    ...
    <data>Sample data</data>
            ...
            return {"success": False, "error": f"Unknown XML operation: {operation}"}
    ...
    async def _csv_operation(self, args: dict) -> dict:
        ...
        if operation == "parse":
            ...
            return {"success": False, "error": f"Unknown CSV operation: {operation}"}
